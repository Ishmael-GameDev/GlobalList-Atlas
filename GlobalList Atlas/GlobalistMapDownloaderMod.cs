    ...
    public void NotifyAutoSaveToggled(bool newState)
{
    ...
    public void SetAutoSaveCatalog(bool enabled)
    {
        ...
        Modding.Logger.Log($"[GlobalListAtlasMod] Автосохранение каталога: {(enabled ? "ВКЛ" : "ВЫКЛ")}");
    }
    ...
    public override void Initialize()
    {
        ...
        Modding.Logger.Log("Мод инициализирован");
    }
    ...
    public void ToggleLanguage()
    {
        ...
        Modding.Logger.Log($"[GlobalListAtlasMod] Язык переключен на: {_settings.CurrentLanguage.ToUpper()}");
